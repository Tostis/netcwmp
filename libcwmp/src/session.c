...
header_t * cwmp_session_create_header(cwmp_session_t * session, pool_t * pool)
{
	...
	//TODO Session as incremental ID or Device Serial Number
    //strncpy(session->id, header->id, 128); // this
    header->id="here.goes.the.serial.number"; // or this one
